    ...
    <div class="container-xxl">
      ...
      >
        ...
        >
          ...
          <li class="mx-3 welcome-text">
            @php
                ...
                $secondsToday = $now->getTimestamp() - $startOfDay->getTimestamp();

                if ($secondsToday < 43200) { // 12 hours in seconds
                    $greeting = 'Good Morning';
                } elseif ($secondsToday < 64800) { // 18 hours in seconds
                    $greeting = 'Good Afternoon';
                } else {
                    $greeting = 'Good Evening';
                }
            @endphp
            <h3 class="mb-0 fw-bold text-truncate">{{$greeting}}, <span class="text-primary">{{Auth::user()->name}}</span> !</h3>
        ...
        >
          ...
          <li class="dropdown topbar-item">
            <a
              class="nav-link dropdown-toggle arrow-none nav-icon bg-transparent"
              data-bs-toggle="dropdown"
              href="#"
              role="button"
              aria-haspopup="false"
            ...
            >
              <img
                src="{{Auth::user()->image ? ".".Storage::url(Auth::user()->image) : "assets/images/users/avatar-default-".(Auth::user()->role == 1 ? "admin" : "staff").".png"}}"
                alt=""
