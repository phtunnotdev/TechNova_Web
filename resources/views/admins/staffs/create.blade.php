                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control {{$errors->has("email") ? "is-invalid" : ""}}" name="email" value="{{old('email')}}" type="text" placeholder="example@gmail.com">
                                        @if ($errors->has("email"))
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control {{$errors->has("address") ? "is-invalid" : ""}}" name="address" rows="4" placeholder="Nhập vào địa chỉ">{{old('address')}}</textarea>
                            ...
                            <div class="col-lg-6">    
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control {{$errors->has("phone") ? "is-invalid" : ""}}" name="phone" value="{{old('phone')}}" type="text" placeholder="Nhập vào số điện thoại">
                                        @if ($errors->has("phone"))
                                ...
                                <div class="text-end mb-3">
                                    <button type="reset" class="btn btn-danger mr1">Cancel</button>
