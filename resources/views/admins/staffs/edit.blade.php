                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="position-relative">
                                            ...
                                            <img src="{{$user->image ? ".".Storage::url($user->image) : "assets/images/users/avatar-default-staff.png"}}" class="image-style position-absolute" style="display: block" id="image" alt="image">
                                        </div>
                                        @if ($errors->has("image"))
