                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <div class="row">
                            ...
                            <div class="col-lg-12">    
                                <div class="mb-3 row">
                                    <label class="col-sm-1 col-form-label text-start">Nội dung <span class="text-danger">*</span></label>
                                     <div class="col-sm-11">
                                            <div id="editor" style="height: 600px;">{!! old('content') !!}</div> <!-- Thay đổi chiều cao ở đây -->
