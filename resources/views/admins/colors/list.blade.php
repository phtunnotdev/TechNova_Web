            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                            <div class="col-auto">
                                <a href="{{ route('color.create') }}"><button type="button" class="btn btn-primary"><i
                                            class="fa-solid fa-plus me-1"></i> Thêm màu sắc</button></a>
                            </div>
                        </div><!--end col-->
                    </div><!--end row-->
                </div><!--end card-header-->
                        ...
                        <table class="table mb-0 checkbox-all">
                            ...
                            <tbody>
                                @foreach ($colors as $color)
                                    <tr>
                                        <td class="font-13 fw-medium">{{ $color->name }}</td>
                                        <td class="text-end">
                                            ...
                                            <form class="d-inline" action="{{ route('color.destroy', $color->id) }}"
                                                ...
                                                <button type="button"
                                                onclick="return alert('Bạn không thể xóa màu này !')"
                                                class="btn-reset"><i
