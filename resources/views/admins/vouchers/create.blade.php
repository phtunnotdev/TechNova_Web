                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control {{$errors->has("percent") ? "is-invalid" : ""}}" name="percent" value="{{old('percent')}}" type="number" placeholder="Nhập vào % giảm giá">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control {{$errors->has("minPrice") ? "is-invalid" : ""}}" name="minPrice" value="{{old('minPrice')}}" type="number" placeholder="Nhập vào giá tối thiểu">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control {{$errors->has("maxPrice") ? "is-invalid" : ""}}" name="maxPrice" value="{{old('maxPrice')}}" type="number" placeholder="Nhập vào giá tối đa">
                            ...
                            <div class="col-lg-6">    
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control {{$errors->has("startDate") ? "is-invalid" : ""}}" name="startDate" value="{{old('startDate')}}" min="{{ date('Y-m-d') }}" type="date">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control {{$errors->has("endDate") ? "is-invalid" : ""}}" name="endDate" min="{{ date('Y-m-d') }}" value="{{old('endDate')}}" type="date">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control {{$errors->has("quantity") ? "is-invalid" : ""}}" name="quantity" value="{{old('quantity')}}" type="number" placeholder="0">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="users[]" class="form-select" multiple>
                                            ...
                                            <option class="text-primary" value="{{$user->id}}">{{$user->name}} ({{$user->user_code}})</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
